...
/**
 * @author Neha Rungta This class tests building equivalence classes and the
 *         partition function for differing shapes when a store operation occurs
 *         on a data-structure of a non-primitive type.
 **/
