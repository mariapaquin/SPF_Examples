...
public class Rational {
	...
	public static void main(String[] args) {
		/*
		 * Rational r0 = new Rational(5,10); Rational r1 = new Rational(2,10); Rational
		 * r2 = new Rational(4,6); Rational[] rs = new Rational[3]; rs[0] = r0; rs[1] =
		 * r1; rs[2] = r2; System.out.print("Original array: "); printArray(rs);
		 * Rational[] oldRs = simp(rs); System.out.print("Simplified array: ");
		 * printArray(rs); System.out.print("Copied array: "); printArray(oldRs);
		 */
		// test(5,10,2,10,4,6);
		// abs(0);
		gcd_composition(0, 0);
