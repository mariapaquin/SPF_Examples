...
public class Reaction_Jet_Control0 {
	...
	public void Main1(double[] Attitude_Cmd__2, double[] Attitude_Meas__3, double[] Yaw_Jets_4,
			double[] Pitch_Roll_Jets_5) {
		...
		while (ix438 < 2) {
			...
			ix442 = 0;
			while (ix442 < 2) {
				sig_24[(ix438)][(ix442)] = Value431[(ix438)][(ix442)];
				++ix442;
			}
		...
		while (ix470 < 2) {
			...
			ix474 = 0;
			while (ix474 < 2) {
				sig_22[(ix470)][(ix474)] = Value463[(ix470)][(ix474)];
				++ix474;
			}
		...
		while (ix502 < 2) {
			...
			ix506 = 0;
			while (ix506 < 2) {
				sig_21[(ix502)][(ix506)] = Value495[(ix502)][(ix506)];
				++ix506;
			}
		...
		ix524 = 0;
		while (ix524 < 3) {
			sig_20[(ix524)] = Attitude_Meas__3[(ix524)] - Attitude_Cmd__2[(ix524)];
			++ix524;
		}
		...
		sig_4 = Attitude_Meas__3[(0)];
		sig_5 = Attitude_Meas__3[(1)];
		sig_6 = Attitude_Meas__3[(2)];
		sig_19 = (NumeratorCoefficients_3554[(0)] * sig_4 + NumeratorCoefficients_3554[(1)] * NumeratorTerms_5557
				- DenominatorCoefficients_4556[(1)] * DenominatorTerms_6558) / DenominatorCoefficients_4556[(0)];
		...
		sig_18 = (NumeratorCoefficients_7588[(0)] * sig_5 + NumeratorCoefficients_7588[(1)] * NumeratorTerms_9591
				- DenominatorCoefficients_8590[(1)] * DenominatorTerms_10592) / DenominatorCoefficients_8590[(0)];
		NumeratorTerms_9591 = sig_5;
		DenominatorTerms_10592 = sig_18;
		sig_17 = (NumeratorCoefficients_11614[(0)] * sig_6 + NumeratorCoefficients_11614[(1)] * NumeratorTerms_13617
				- DenominatorCoefficients_12616[(1)] * DenominatorTerms_14618) / DenominatorCoefficients_12616[(0)];
		NumeratorTerms_13617 = sig_6;
		DenominatorTerms_14618 = sig_17;
		sig_14.signal1 = sig_18;
		sig_14.signal2 = sig_17;
		sig_14_array_15[(0)] = sig_14.signal1;
		sig_14_array_15[(1)] = sig_14.signal2;
		ix661 = 0;
		while (ix661 < 2) {
			kx658 = 0;
			sum659 = 0;
			while (kx658 < 2) {
				sum659 += sig_21[(ix661)][(kx658)] * sig_14_array_15[(kx658)];
				++kx658;
			}
		...
		sig_10 = sig_1[(0)];
		sig_11 = sig_1[(1)];
		sig_15_array_18[(0)] = sig_15.signal1;
		sig_15_array_18[(1)] = sig_15.signal2;
		ix699 = 0;
		while (ix699 < 2) {
			kx696 = 0;
			sum697 = 0;
			while (kx696 < 2) {
				sum697 += sig_22[(ix699)][(kx696)] * sig_15_array_18[(kx696)];
				++kx696;
			}
		...
		sig_16_array_21[(0)] = sig_16.signal1;
		sig_16_array_21[(1)] = sig_16.signal2;
		ix763 = 0;
		while (ix763 < 2) {
			kx760 = 0;
			sum761 = 0;
			while (kx760 < 2) {
				sum761 += sig_24[(ix763)][(kx760)] * sig_16_array_21[(kx760)];
				++kx760;
			}

			Pitch_Roll_Jets_5[(ix763)] = sum761;
			++ix763;
		}
	...
	public void Init3() {
		...
		Value431[(1)][(0)] = 1;
		Value431[(1)][(1)] = 1;
		Value463[(0)][(0)] = 0.707106781186547570000;
		Value463[(0)][(1)] = 0.707106781186547570000;
		Value463[(1)][(0)] = -0.707106781186547570000;
		Value463[(1)][(1)] = 0.707106781186547570000;
		Value495[(0)][(0)] = 0.707106781186547570000;
		Value495[(0)][(1)] = 0.707106781186547570000;
		Value495[(1)][(0)] = -0.707106781186547570000;
		Value495[(1)][(1)] = 0.707106781186547570000;
		NumeratorCoefficients_3554[(0)] = 10;
		NumeratorCoefficients_3554[(1)] = -10;
		DenominatorCoefficients_4556[(0)] = 1;
		DenominatorCoefficients_4556[(1)] = 0;
		NumeratorTerms_5557 = 0;
		DenominatorTerms_6558 = 0;
		NumeratorCoefficients_7588[(0)] = 10;
		NumeratorCoefficients_7588[(1)] = -10;
		DenominatorCoefficients_8590[(0)] = 1;
		DenominatorCoefficients_8590[(1)] = 0;
		NumeratorTerms_9591 = 0;
		DenominatorTerms_10592 = 0;
		NumeratorCoefficients_11614[(0)] = 10;
		NumeratorCoefficients_11614[(1)] = -10;
		DenominatorCoefficients_12616[(0)] = 1;
		DenominatorCoefficients_12616[(1)] = 0;
