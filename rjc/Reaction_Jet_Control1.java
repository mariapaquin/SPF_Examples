...
public class Reaction_Jet_Control1 {
	...
	public void Main1(double[] Attitude_Cmd__2, double[] Attitude_Meas__3, double[] Yaw_Jets_4,
		...
		while (ix447 < 2) {
			...
			ix451 = 0;
			while (ix451 < 2) {
				sig_24[(ix447)][(ix451)] = Value440[(ix447)][(ix451)];
				++ix451;
			}
		...
		while (ix479 < 2) {
			...
			ix483 = 0;
			while (ix483 < 2) {
				sig_22[(ix479)][(ix483)] = Value472[(ix479)][(ix483)];
				++ix483;
			}
		...
		while (ix511 < 2) {
			...
			ix515 = 0;
			while (ix515 < 2) {
				sig_21[(ix511)][(ix515)] = Value504[(ix511)][(ix515)];
				++ix515;
			}
		...
		ix533 = 0;
		while (ix533 < 3) {
			sig_20[(ix533)] = Attitude_Meas__3[(ix533)] - Attitude_Cmd__2[(ix533)];
			++ix533;
		}
		...
		sig_14_array_3[(0)] = sig_14.signal1;
		sig_14_array_3[(1)] = sig_14.signal2;
		ix592 = 0;
		while (ix592 < 2) {
			kx589 = 0;
			sum590 = 0;
			while (kx589 < 2) {
				sum590 += sig_21[(ix592)][(kx589)] * sig_14_array_3[(kx589)];
				++kx589;
			}
		...
		sig_10 = sig_1[(0)];
		sig_11 = sig_1[(1)];
		sig_15_array_6[(0)] = sig_15.signal1;
		sig_15_array_6[(1)] = sig_15.signal2;
		ix630 = 0;
		while (ix630 < 2) {
			kx627 = 0;
			sum628 = 0;
			while (kx627 < 2) {
				sum628 += sig_22[(ix630)][(kx627)] * sig_15_array_6[(kx627)];
				++kx627;
			}
		...
		sig_16_array_9[(0)] = sig_16.signal1;
		sig_16_array_9[(1)] = sig_16.signal2;
		ix694 = 0;
		while (ix694 < 2) {
			kx691 = 0;
			sum692 = 0;
			while (kx691 < 2) {
				sum692 += sig_24[(ix694)][(kx691)] * sig_16_array_9[(kx691)];
				++kx691;
			}

			Pitch_Roll_Jets_5[(ix694)] = sum692;
			++ix694;
		}
	...
	public void Init3() {
		...
		Value440[(1)][(0)] = 1;
		Value440[(1)][(1)] = 1;
		Value472[(0)][(0)] = 0.707107;
		Value472[(0)][(1)] = 0.707107;
		Value472[(1)][(0)] = -0.707107;
		Value472[(1)][(1)] = 0.707107;
		Value504[(0)][(0)] = 0.707107;
		Value504[(0)][(1)] = 0.707107;
		Value504[(1)][(0)] = -0.707107;
		Value504[(1)][(1)] = 0.707107;
