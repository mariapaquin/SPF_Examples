...
public class Yaw_Control_Law2 {
	...
	public void Main4(double Position_2, double Rate_3, double[] Jet_Command_4) {
		...
		sig_13 = (sig_22[0]) * Gain844;
		sig_10 = Value859;
		sig_4 = Value871;
		sig_12 = (1) / sig_19 / sig_4 * sig_10;
		ix900 = 0;
		while (ix900 < 2) {
			sig_11[(ix900)] = sig_18[(ix900)] / sig_4 / sig_19;
			++ix900;
		}
		...
		sig_20 = sig_11[(0)];
		sig_3 = (Math.abs(sig_20));
		sig_29 = sig_30 + sig_3 - sig_12;
		sig_1 = sig_29 * Gain1003;
		sig_2 = sig_1 * ((sig_1 >= 0) ? 1 : 0);
		sig_24 = (Math.sqrt(sig_2));
		Chart_member12.Main(sig_19, sig_18, sig_25[0], sig_26[0], sig_27[0], sig_28[0], sig_21, sig_24, sig_5, sig_6,
				sig_7);
		sig_8 = sig_6[0] != 0;
		sig_0 = (int) (Math.floor(sig_22[0] / 160.0)) * 160;
		sig_14 = (sig_0) * Gain1117;
		Jet_On_TIme_Counter_100000140_class_member13.Main14(sig_7[0], sig_13, sig_14, sig_15);
