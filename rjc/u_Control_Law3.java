...
public class u_Control_Law3 {
	...
	public void Main6(double Position_2, double Rate_3, double[] Jet_Command_4) {
		...
		sig_13 = (sig_22[0]) * Gain918;
		sig_10 = Value932;
		sig_4 = Value944;
		sig_12 = (1) / sig_19 / sig_4 * sig_10;
		ix985 = 0;
		while (ix985 < 2) {
			sig_11[(ix985)] = sig_18[(ix985)] / sig_4 / sig_19;
			++ix985;
		}
		...
		Chart_member13.Main(sig_19, sig_18, sig_25[0], sig_26[0], sig_27[0], sig_28[0], sig_21, sig_24, sig_5, sig_6,
				sig_7);
		sig_8 = sig_6[0] != 0;
		sig_0 = (int) (Math.floor(sig_22[0] / 160)) * 160;
		sig_14 = (sig_0) * Gain1210;
